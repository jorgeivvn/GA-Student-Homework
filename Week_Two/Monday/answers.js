...
//Couldn't figure this one out, want to go through it in class w/ Daniel. Also was wondering if there was a way to incorporate Array.from to this problem....
...
// console.log(Array.from(bondFilms[0].title));
